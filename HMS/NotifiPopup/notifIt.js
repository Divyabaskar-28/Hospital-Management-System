...
var to, width, height, position, autohide, opacity, linheight;
...
function notif(config){
    ...
    if (linheight == 0) { $("#ui_notifIt p").css("line-height", "none"); $("#ui_notifIt").css("height", "50px"); } else { $("#ui_notifIt p").css("line-height", height + "px"); }
